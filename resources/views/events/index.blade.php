	...
	<div class="panel-heading">
		...
		<div class="clearfix">
			...
			<div class="pull-right">
				<a class="btn btn-success btn-xs" href="{{ URL::to('/events/add') }}" title="Add Item" role="button"><span class="fa fa-plus"></span> Add Item</a>
			</div>
		</div>
	</div>
	<div class="panel-body">
		{!! Form::open(array('name' => 'search_form', 'url' => URL::to('events'), 'class'=>'form-inline', 'role' => 'form')) !!}
	...
	<div class="table-responsive">
		...
		<thead>
			<tr>
				...
				<th class="nowrap text-center"># of Visitors</th>
			</tr>
		</thead>
		<tbody>
			<?php $i = 0; ?>
		    @foreach($rows as $row)
		    <?php $i++; ?>
		    @include('events.index_row', ['row' => $row, 'i' => $i])
		    @endforeach
		</tbody>
		</table>
	</div>
